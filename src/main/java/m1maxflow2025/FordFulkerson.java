...
/**
 * Implements the Ford-Fulkerson algorithm for computing the maximum flow in a
 * flow network.
 * It uses a generic pathfinding strategy (e.g., BFS, DFS) defined by the
...
public class FordFulkerson {
	 ...
	 * Different implementations can yield different variations of the algorithm
	 * (e.g., Edmonds-Karp).
	 */
	...
	/**
	 * Computes the maximum flow in a FlowNetwork using the Ford-Fulkerson
	 * algorithm.
	 *
	 * @param fn         The initial flow network
	 * @param pathFinder The strategy used to find augmenting paths in the residual
	 *                   graph
